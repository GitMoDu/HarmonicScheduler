...
namespace Harmonic
{
	namespace Selector
	{
		template<task_handle_t MaxTaskCount, bool IdleSleepEnabled, ProfileLevelEnum  Level>
		struct TemplateSchedulerSelector;

		template<task_handle_t MaxTaskCount, bool IdleSleepEnabled>
	...
	template<task_handle_t MaxTaskCount, bool IdleSleepEnabled = false, ProfileLevelEnum  Level = ProfileLevelEnum::None>
